...
import com.example.tugas_uts_akb_if3_10117097_imamjatipermana.Database.AdapterFriend;
import com.example.tugas_uts_akb_if3_10117097_imamjatipermana.Database.FriendHelper;
import com.example.tugas_uts_akb_if3_10117097_imamjatipermana.Database.MapHelper;
        ...
        if (data != null) {
            if (requestCode == FriendUpdateActivity.REQUEST_ADD) {
                if (resultCode == FriendUpdateActivity.RESULT_ADD) {
                    ...
                    showSnackbarMessage("One Iten Has Been Added");
                }
                ...
                if (resultCode == FriendUpdateActivity.RESULT_UPDATE) {
                    ...
                    showSnackbarMessage("One Item Has Been Changed");
                } else if (resultCode == FriendUpdateActivity.RESULT_DELETE) {
                    int position = data.getIntExtra(FriendUpdateActivity.EXTRA_POSITION, 0);

                    adapter.removeItem(position);

                    showSnackbarMessage("One Item Has Been Deleted");
                }
            }
        }
    }
